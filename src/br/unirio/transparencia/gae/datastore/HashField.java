...
public class HashField
{
	...
	/**
	 * Retorna o n�mero de campos no hash table
	 */
	public int count()
	{
		return fields.size();
	...
	/**
	 * Adiciona um campo do tipo num�rico no hash table
	 */
	...
	/**
	 * Retorna o valor de um campo num�rico da hash table
	 */
	...
	/**
	 * Gera a representa��o string da tabela
	 */
